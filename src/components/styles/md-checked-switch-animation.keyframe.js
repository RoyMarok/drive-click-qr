...
export const mdCheckedSwitchAnimation = keyframes`
    ...
    6% { transform: translateX(11px) }
    7% { transform: translateX(13px) }
    8% { transform: translateX(15px) }
    9% { transform: translateX(16px) }
    10% { transform: translateX(17px) }
    11% { transform: translateX(18px) }
    12% { transform: translateX(19px) }
    16% { transform: translateX(18px) }
    19% { transform: translateX(17px) }
